        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <img
                src="/img/cursus/iut.jpg"
                alt={t("formation.2024.iut_img_alt")}
                title={t("formation.2024.iut_img_alt")}
              />
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <img
                src="/img/cursus/lycee.png"
                alt={t("formation.2022.lyc_img_alt")}
                title={t("formation.2022.lyc_img_alt")}
              />
              <li>
